...
require (
	...
	github.com/SENERGY-Platform/mqtt-platform-connector v0.0.3
...
require (
	...
	github.com/SENERGY-Platform/platform-connector-lib v0.0.0-20240105124530-e51c7fbf01e8 // indirect
