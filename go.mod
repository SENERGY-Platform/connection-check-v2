...
require (
	...
	github.com/SENERGY-Platform/mqtt-platform-connector v0.0.2
...
require (
	...
	github.com/SENERGY-Platform/platform-connector-lib v0.0.0-20240102085656-1610948334c8 // indirect
