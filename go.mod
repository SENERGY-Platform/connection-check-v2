...
require (
	...
	github.com/SENERGY-Platform/mqtt-platform-connector v0.0.0-20230717055542-10000eecb965
...
require (
	...
	github.com/SENERGY-Platform/platform-connector-lib v0.0.0-20230516110647-6795752e65e9 // indirect
